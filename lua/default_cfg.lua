...
local __doc = {}
__doc.pwd = 'Password for subject line commands'
__doc.ham_db = 'Ham database filename.'
__doc.spam_db = 'Spam database filename.'
__doc.min_pR_success = 'Minimum pR value to be considered as ham'
__doc.threshold = [[
...
__doc.tag_subject     = 'Flag to turn on of off subject tagging' 
__doc.tag_spam        = [[Tag to be prepended to the subject line of
spam messages]]
__doc.tag_unsure_spam = [[Tag to be prepended to the subject line of
low abs score spam messages]]
__doc.tag_unsure_ham = [[Tag to be prepended to the subject line of
of low score ham messages]]
__doc.tag_ham = 'Tag to be prepended to the subject line of ham messages'

__doc.trained_as_spam    = 'Result string for messages trained as spam'
__doc.trained_as_ham     = 'Result string for messages trained as ham'
__doc.training_not_necessary = [[Result string for messages which don't
 need training]]

__doc.use_sfid     = 'Flag to turn on or off use of SFID'
__doc.rightid      = [[String with SFID's right id. Defaukts to
spamfilter.osbf.lua.]]

__doc.insert_sfid_in  = [[Specifies where SFID must be inserted.
Valid values are:
 {"references"}, {"message-id"} or {"references", "message-id"}.
]]

__doc.save_for_training = [[Save messages for later training,
if set to true. Defaults to true.]]
__doc.log_incoming      = [[Log all incoming messages, if set to true.
Defauts to true.]]
__doc.log_learned       = [[Log all learned messages, if set to true.
Defaults to true.]]
__doc.log_dir           = [[Name of the log dir, relative to the user
osbf-lua dir. Defaults to "log".]]

__doc.use_sfid_subdir = [[If use_sfid_subdir is true, messages cached
...
__doc.count_classifications = [[Flag to turn on or off classification
counting.]]

__doc.output  = [[If output is set to 'message', the original message
...
__doc.remove_body_threshold = [[Set remove_body_threshold to the score
...
__doc.mail_cmd = [[Command to send pre-formatted command messages.
